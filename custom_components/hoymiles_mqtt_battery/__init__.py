...
def entry_config(entry: ConfigEntry) -> dict[str, Any]:
    ...
    Options override the original setup data so the Options Flow can add/remove
    batteries or change global settings without recreating the entry.
    """
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    hub = HoymilesMqttHub(hass, config)
